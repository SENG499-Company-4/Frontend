...
import { Box, Button, Dialog, DialogActions, DialogContent, DialogContentText, DialogTitle, Divider, Grid, MenuItem, TextField, Typography } from '@mui/material';
import { backendUrl, backendUrlInverse, company, companyInverse } from 'components/shared/constants/plugandplay.constants';
...
function PlugAndPlay() {
    ...
    const submitChanges = () => {
        ...
        axios.patch('https://api.heroku.com/apps/seng499company4frontend/config-vars', configVars, config)
            .then(res => { 
                console.log(res);
                cookies.remove('user');
            ...
            <Box sx={{ flexGrow: 1, margin: 5 }}>
                ...
                >
                    ...
                    <DialogContent>
                        ...
                        <DialogContentText id="alert-dialog-slide-description" marginTop={"10px"}>
                            If you change the backend connection, you will lose access to all database-stored content associated with this backend. This includes existing users, schedules, and preference surveys. If you change either algorithm, you will experience different algorithmic results.
                        </DialogContentText>
                        <DialogContentText id="alert-dialog-slide-description" marginTop={"10px"}>
