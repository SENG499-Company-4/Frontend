...
const columns: GridColDef[] = [
  ...
  { field: 'term', headerName: 'Term', width: 130 },
  {
    ...
    width: 200,
    renderCell: (params: any) => <Link href={params.value}> link </Link>
  }
];
...
function ProfessorsList() {
  ...
  return (
    <Box sx={{ width: 1000, margin: 'auto' }}>
      ...
      <DataGrid autoHeight rows={rows} columns={columns} pageSize={20} rowsPerPageOptions={[5]} checkboxSelection />
    </Box>
  );
}
